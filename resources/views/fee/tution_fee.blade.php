...
<div class="container mb-5 mt-5">
    <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10">
            ...
            <h2 class="text-center mb-4"> Fee Payment</h2>
            <p class="text-center text-muted mb-4">
                Fill student details and pay your fee securely.
            </p>

            <form action="{{route('submit.fee')}}" method="POST" id="tuitionForm">
                @csrf
                <input type="hidden" name="type" value="tuition_fee">
                ...
                <div class="card shadow-sm p-4 mb-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <label for="college_name" class="form-label">Coatching Name</label>
                        ...
                        <button type="submit" id="feeBtn" class="btn btn-primary w-100 py-2">Pay Fee</button>
                    </div>
                </div>
            </form>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on("submit", "#tuitionForm", function(e) {
            e.preventDefault();
            let form = $(this);
            let btn = $("#feeBtn");
            ...
            $.ajax({
                ...
                complete: function() {
                    btn.html("Pay Now").attr("disabled", false);
                }
            });
        });
